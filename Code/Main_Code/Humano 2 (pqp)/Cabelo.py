...
def gerar_Cabelo_filho(Zigoto_Cabelo_Mae, Zigoto_Cabelo_Pai):
    ...
    if soma_Cabelo == 132:  # Castanho e Preto juntos
...
# Gerar a cor dos Cabelo do filho
for i in range (100):
    cor_Cabelo_filho = gerar_Cabelo_filho(Zigoto_Cabelo_Mae, Zigoto_Cabelo_Pai)
    print(f"Cabelo do filho: {cor_Cabelo_filho}")
